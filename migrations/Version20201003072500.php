 ...
 */
final class Version20201003072500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_verification_url (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, verification_type VARCHAR(255) NOT NULL, verification_key VARCHAR(255) NOT NULL, expired_date_time DATETIME NOT NULL, INDEX IDX_274A535A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_verification_url ADD CONSTRAINT FK_274A535A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_verification_url DROP FOREIGN KEY FK_274A535A76ED395');
        ...
        $this->addSql('DROP TABLE user_verification_url');
